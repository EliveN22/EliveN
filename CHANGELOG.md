...
### 10.42
 ...
 - EliveN version shown in title at main menu
...
### 9.21
 ...
 - Added retrocompatibility for mdk3, added option in .EliveNrc file to handle it
...
### 9.11
 ...
 - Options .EliveNrc file now also updated on automatic update keeping user's preferences
...
### 7.01
 ...
 - The existing iptables rules before the launch of EliveN are now restored upon exiting if modified
...
### 6.21
 ...
 - Fixed error executing EliveN after auto-update on some Linux distributions
...
### 3.2
 ...
 - Changed version var to EliveN_version for future version check (auto-update feature)
